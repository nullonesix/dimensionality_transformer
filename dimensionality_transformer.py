...
dimensionality_growth = True

def train(model: nn.Module, epoch, epochs) -> None:
    ...
    for batch, i in enumerate(range(0, train_data.size(0) - 1, bptt)):
        ...
        if dimensionality_growth:
            for param in model.parameters():
                # if len(param.grad.shape) == 1:
                #     param.grad[param.shape[0]*batch//num_batches:param.shape[0]] = 0
                # if len(param.grad.shape) == 2:
                #     param.grad[param.shape[0]*batch//num_batches:param.shape[0], param.shape[1]*batch//num_batches:param.shape[1]] = 0
                if len(param.grad.shape) == 1:
                    param.grad[param.shape[0]*epoch//epochs:param.shape[0]] = 0
                if len(param.grad.shape) == 2:
                    param.grad[param.shape[0]*epoch//epochs:param.shape[0], param.shape[1]*epoch//epochs:param.shape[1]] = 0
